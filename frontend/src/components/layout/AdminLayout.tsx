    ...
    <div className="flex min-h-screen flex-col bg-[#FFEDDB] text-[#1A1412] antialiased">
      ...
      <div className="md:hidden pt-20 px-4 py-2 bg-[#FFFFFF] border-b border-[#DFC1B0] flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-[#1A1412]"></span>
          <span className="font-sans text-xs font-bold uppercase tracking-wider text-[#1A1412]">
        ...
        >
          {mobileDrawerOpen ? "Close Menu" : "Admin Navigation"}
        </button>
      </div>
